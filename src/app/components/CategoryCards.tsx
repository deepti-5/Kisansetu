...
export default function CategoryCards() {
  ...
  const CATEGORIES = [
    {
      id: 'equipment',
      titleKey: 'catEquipmentTitle',
      subtitleKey: 'catEquipmentSubtitle',
      href: '/equipment-listing-page',
      color: 'from-green-600 to-green-800',
      badgeKey: 'catEquipmentBadge',
    ...
    {
      id: 'labour',
      titleKey: 'catLabourTitle',
      subtitleKey: 'catLabourSubtitle',
      href: '/labour',
      color: 'from-blue-600 to-blue-800',
      badgeKey: 'catLabourBadge',
    ...
    {
      id: 'agri',
      titleKey: 'catAgriTitle',
      subtitleKey: 'catAgriSubtitle',
      href: '/agri',
      color: 'from-amber-500 to-amber-700',
      badgeKey: 'catAgriBadge',
          ...
          {CATEGORIES?.map((cat) => (
            ...
            >
              <div className="relative h-40 overflow-hidden">
                <AppImage src={cat?.image} alt={cat?.imageAlt} fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
              ...
              <div className="bg-card p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h3 className="font-bold text-lg text-foreground">{t(cat?.titleKey)}</h3>
                </div>
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">{t(cat?.subtitleKey)}</p>
