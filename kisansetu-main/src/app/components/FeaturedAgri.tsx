        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div key={product.id} className="card-base card-hover overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                    <span className="bg-danger text-white text-xs font-bold px-3 py-1.5 rounded-full">
                      Out of Stock
                    </span>
                  </div>
              }
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  suppressHydrationWarning
                  className={`text-xs py-2 rounded-lg font-semibold transition-all btn-press text-center ${
                  product.inStock ?
                  'gradient-green text-white hover:opacity-90' : 'bg-muted text-muted-foreground cursor-not-allowed pointer-events-none'}`
                  }>
                  ...
                  className={`flex items-center justify-center gap-1.5 text-xs py-2 rounded-lg font-semibold border-2 transition-all btn-press ${
                  cartAdded.includes(product.id) ?
                  'border-success text-success bg-success-bg' :
                  product.inStock ?
                  'border-primary text-primary hover:bg-secondary' : 'border-muted text-muted-foreground cursor-not-allowed'}`
                  }>
