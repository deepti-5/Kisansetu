...
},
{
  ...
  distance: 6.2,
  skills: ['Pesticide Spraying', 'Crop Care', 'Irrigation'],
  experience: '4 years',
  available: false,
  phone: '+919876543212'
},
              ...
              <div className="p-4">
                <div className="flex items-start gap-3 mb-3">
                  <div className="relative shrink-0">
                    ...
                    person.available ? 'bg-success' : 'bg-muted-foreground'}`
                    } />
                  ...
                  wishlist.includes(person.id) ?
                  'bg-danger text-white' : 'bg-muted text-muted-foreground hover:bg-danger/10 hover:text-danger'}`
                  }>
                ...
                <span key={`skill-${person.id}-${skill}`} className="badge-green text-xs">
                      {skill}
                    </span>
                )}
                  {person.skills.length > 2 &&
                <span className="badge-blue text-xs">+{person.skills.length - 2}</span>
                }
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  person.available ?
                  'gradient-green text-white hover:opacity-90 btn-press' : 'bg-muted text-muted-foreground cursor-not-allowed'}`
                  }>
                  ...
                  className="btn-secondary text-xs py-2 gap-1.5 flex items-center justify-center">
                    <Phone size={13} />
                    Call
                  </a>
                </div>
